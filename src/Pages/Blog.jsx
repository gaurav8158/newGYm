      ...
      <section className="bg-[#151515]">
        ...
        <div className="py-[10rem] container gap-16 page-padding grid grid-cols-[64fr_35fr] md1000:grid-cols-1 md1000:gap-32">
          ...
          <div>
            ...
            {/* categories */}
            <div className="flex rounded-2xl shadow-gray-800 shadow-sm  flex-col bg-[#110f0f] my-[35px] p-[30px]">
              <p className="text-[18px] text-white font-bold mb-5">
                Categories
              </p>
              <span className="w-[40px] h-[3.5px] bg-[#ff0336]"></span>
              <ul className="text-[16px] text-[#d1cdcd] font-medium mt-10">
            ...
            {/* recent posts */}
            <div className="flex flex-col rounded-2xl shadow-gray-800 shadow-sm  bg-[#110f0f] my-[35px] p-[30px]">
              <p className="text-[18px] text-white font-bold mb-5">
                Recent Posts
              </p>
              ...
              <div className="flex flex-col gap-7">
                {/*  */}
                <div className="flex gap-8 group border-b border-slate-700 pb-4">
                  <img src={Recent1} alt="recent_img" className="w-[10rem]" />
                  <div className="flex flex-col gap-4 justify-center">
                    <p className="text-[14px] text-[#d1cdcd] font-medium">
                      March 22, 2024
                    </p>
            ...
            <div className="flex flex-col rounded-2xl shadow-gray-800 shadow-sm  bg-[#110f0f]  my-[35px] p-[30px]">
              ...
              <div className="flex gap-3 text-[16px] text-[#646464] font-medium flex-wrap">
                <p className="bg-[#353434] text-white py-[4px] px-[14px] hover:text-[#ff0336] ease-in duration-200 cursor-pointer">
                  #Crossfit
                </p>
                <p className="bg-[#353434] text-white py-[4px] px-[14px] hover:text-[#ff0336] ease-in duration-200 cursor-pointer">
                  #Fitness
            ...
            {/* banner */}
            <div className="blog-banner rounded-2xl shadow-gray-800 shadow-sm  w-full h-[56rem] relative">
