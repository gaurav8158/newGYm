        ...
        <div className="page-padding py-[10rem] flex justify-center">
          ...
          >
            ...
            <input
              ...
              placeholder="The Power Squad Gym@gymail.com"
              type="email"
            ...
            <div className="flex gap-4 items-center mt-16 min450:flex-col">
              <p className="text-white text-[1.5rem]">New to The Power Squad Gym?</p>
              <Link
                to="/signup"
            ...
            <p className="text-[#ffffffbc] text-[1.4rem] mt-3">
              ...
              The Power Squad Gym@gymail.com <span className="text-[#ff0336]"> / </span>
              testpassword123
            </p>
          </form>
        </div>
