...
function Featured() {
  ...
  return (
    <>
      <section id="featured" className="page-padding py-[12.5rem] bg-[#151515]">
        <div className="container">
          ...
          <div className="flex flex-col text-center items-center relative ">
            <motion.p
              ...
              className="text-3xl text-[#FF0336] font-medium"
            >
              OUR FEATURED CLASS
            </motion.p>
          ...
          <motion.div
            ...
            className="grid grid-cols-4 grid-rows-2 gap-7 h-full mt-7 md1000:flex md1000:flex-col"
          >
            ...
            <div className="item-1-div relative">
              ...
              <div className="absolute z-10 bottom-10 left-10">
                <p className="text-white text-[3rem] font-bold">Zumba</p>
                {/* <p className="text-white bg-[#FF0336] text-[16px] mt-3 py-1 px-5">
            ...
            <div className="item-3-div relative">
              ...
              <div className="absolute z-10 bottom-10 left-10">
                <p className="text-white  text-[3rem] ml-24 font-bold">
                  Yoga &
                </p>
      ...
      <div className="featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#ff0336]">
        <div className="container page-padding ">
          <div className="flex items-center md1000:flex-col md1000:gap-12  md1000:text-center">
            <h2 className="text-white font-bold text-[3.7rem] md1000:text-[3rem] max-w-6xl px-7 leading-[1.2] min450:text-[2rem] ">
